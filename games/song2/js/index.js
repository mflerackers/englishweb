...
let gameData = {
    ...
    "a box of red clams":["a box of red clams.png"],
    "a lot of bad bears":["a lot of bad bears.png"],
    "an odd rat has an umbrella":["an odd rat has an umbrella.png"],
    ...
    "some red and black swans":["some red and black swans"],
    "a bad bug on a bed":["a bad bug on a bed"],
    ...
    "a bug on the back of a heron":["a bug on the back of a heron.png"],
    ...
    "a musk ox gets a snack of some grass":["a musk ox gets a snack of some grass.png"],
}
let sentence = ""
